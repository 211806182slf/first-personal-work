...
for i in range(0, 1024):
    url = 'https://coral.qq.com/article/5963137527/comment/v2?callback=_article5963137527commentv2&orinum=10&oriorder=o&pageflag=1&cursor=' + cursor + '&scorecursor=0&orirepnum=2&reporder=o&reppageflag=1&source=1&_=' + str(page)
